...
<body>
    ...
    <script>
        function initMap() {
            ...
            var regions = [
                { name: 'Patagonia', coordinates: [[-41.0, -73.0], [-41.0, -63.0],  [-56.0, -63.0], [-56.0, -73.0]], color: 'blue' },
     ...
     [-29.0, -72.0],
            ...
            for (var i = 0; i < regions.length; i++) {
                ...
                L.polygon(region.coordinates, { color: region.color }).addTo(map).bindPopup('<strong>' + region.name + '</strong>');
            }
        }
    </script>
    <script>
